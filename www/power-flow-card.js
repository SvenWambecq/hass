 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function at(t) {
    return (e, i) => void 0 !== i ? ((t, e, i) => { e.constructor.createProperty(i, t) })(t, e, i) : nt(t, e)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */; function pt(t) { return !isNaN(parseFloat(t)) && !isNaN(Number(t)) } function vt(t, e = 0) { return pt(t) ? Number(t) : e } function gt(t, e = /\s+/) { const i = []; if (null != t) { const r = Array.isArray(t) ? t : `${t}`.split(e); for (const t of r) { const e = `${t}`.trim(); e && i.push(e) } } return i } console.groupCollapsed("%c⚡ Power Flow Card v2.6.2 is installed", "color: #488fc2; font-weight: bold"), console.log("Readme:", "https://github.com/ulic75/power-flow-card"), console.groupEnd(); const mt = function (t, e, i) { var r; return void 0 === i && (i = !1), function () { var s = [].slice.call(arguments), o = this, n = function () { r = null, i || t.apply(o, s) }, a = i && !r; clearTimeout(r), r = setTimeout(n, e), a && t.apply(o, s) } }((t => { console.log(`%c⚡ Power Flow Card v2.6.2 %cError: ${t}`, "color: #488fc2; font-weight: bold", "color: #b33a3a; font-weight: normal") }), 500); let yt = class extends st {
    constructor() { super(...arguments), this._config = {}, this.unavailableOrMisconfiguredError = t => mt(`entity "${null != t ? t : "Unknown"}" is not available or misconfigured`), this.entityAvailable = t => { var e; return pt(null === (e = this.hass.states[t]) || void 0 === e ? void 0 : e.state) }, this.entityInverted = t => this._config.inverted_entities.includes(t), this.previousDur = {}, this.circleRate = (t, e) => { var i, r; const s = null === (i = this._config) || void 0 === i ? void 0 : i.min_flow_rate, o = null === (r = this._config) || void 0 === r ? void 0 : r.max_flow_rate; return o - t / e * (o - s) }, this.getEntityState = t => t && this.entityAvailable(t) ? vt(this.hass.states[t].state) : (this.unavailableOrMisconfiguredError(t), 0), this.getEntityStateWatts = t => { if (!t || !this.entityAvailable(t)) return this.unavailableOrMisconfiguredError(t), 0; const e = this.hass.states[t], i = vt(e.state); return "W" === e.attributes.unit_of_measurement ? i : 1e3 * i }, this.displayValue = t => { if (null === t) return "0"; const e = t >= this._config.watt_threshold; return `${o(e ? ut(t / 1e3, this._config.kw_decimals) : ut(t, this._config.w_decimals), this.hass.locale)} ${e ? "kW" : "W"}` } } setConfig(t) { if (!t.entities || !t.entities.battery && !t.entities.grid && !t.entities.solar) throw new Error("At least one entity for battery, grid or solar must be defined"); this._config = Object.assign(Object.assign({}, t), { inverted_entities: gt(t.inverted_entities, ","), kw_decimals: vt(t.kw_decimals, 1), min_flow_rate: vt(t.min_flow_rate, .75), max_flow_rate: vt(t.max_flow_rate, 6), w_decimals: vt(t.w_decimals, 1), watt_threshold: vt(t.watt_threshold) }) } getCardSize() { return 3 } render() {
